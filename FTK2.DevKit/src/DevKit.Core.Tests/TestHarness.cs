...
namespace FTK2Mods.DevKit.Tests
{
    ...
    internal static class TestHarness
    {
        ...
        internal static void Run(string name, Action body)
        {
            ...
            {
                // Every test starts from a clean service; ParityService state is process-global.
                ParityService.ResetAll();
                ParityService.SetLogger(null);
            }
        }
        ...
        internal static void EqualKind(ParityVerdictKind expected, ParityVerdictKind actual, string message)
        {
            if (expected != actual)
