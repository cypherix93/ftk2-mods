...
{
    /// <summary>Minimal assertion helpers for the console-runner test harness (no xunit -- see
    /// Blessings.Core.Tests.csproj; identical shape to Summoner.Core.Tests.Check).</summary>
